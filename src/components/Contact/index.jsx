...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className="flex text-center flex-col gap-12 mt-20 min-h-screen overflow-hidden">
      <div className="text-5xl font-bold mt-20" data-aos={"fade"}>
        Contact
      </div>
        ...
        <div className="flex-auto  w-32 pl-10 overflow-visible">
          <form onSubmit={handleSubmit} data-aos={"slide-up"}>
            ...
            <textarea
              ...
              className="block h-40 text-white mt-10 p-2.5 w-full text-sm rounded-lg border bg-gray-700 border-gray-600 focus:ring-blue-500 focus:border-blue-500 resize-none"></textarea>
            <button
              type="submit"
              className={`${
        ...
        <div className="flex-auto w-80  flex flex-col justify-center text-center items-center  gap-1">
          ...
          <div data-aos={"slide-up"} className="text-center">
            ...
            <div className="text-white flex flex-row gap-7 w-fit mx-auto pt-4">
              <div
                onClick={() =>
                  window.open("https://github.com/BrightestWeb", "_blank")
                }>
